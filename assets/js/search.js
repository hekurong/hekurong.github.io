...
(function () {
  ...
  function renderSearchHistory() {
    ...
    for (var i = 0; i < h.length; i++) {
      html += '<span class="search-history-item"><span class="search-history-text">' + escapeHtml(h[i]) + '</span><button class="search-history-del" data-query="' + escapeHtml(h[i]) + '" title="移除"><svg viewBox="0 0 16 16"><line x1="4" y1="4" x2="12" y2="12"/><line x1="12" y1="4" x2="4" y2="12"/></svg></button></span>';
    }
    html += '</div>';
    searchResults.innerHTML = html;
